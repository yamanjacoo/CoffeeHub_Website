  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        foreground: "#3A2E2A", // Dark coffee brown (text)
        primary: {
        ...
        muted: {
          DEFAULT: "#8B5A2B", // Medium espresso brown (subtle text, borders)
          foreground: "#F5F1E9", // Light cream (text on muted backgrounds)
        },
        accent: {
